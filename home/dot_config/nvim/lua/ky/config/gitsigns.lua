...
gitsigns.setup {
  ...
  keymaps = {
    ...
    ['n <Leader>hb'] = '<Cmd>lua require"ky.config.gitsigns".stage_buffer()<CR>',
    ['n <Leader>hs'] = '<Cmd>lua require"ky.config.gitsigns".stage_hank()<CR>',
    ['v <Leader>hs'] = '<Cmd>lua require"ky.config.gitsigns".stage_hank_range()<CR>',
    ['n <Leader>hu'] = '<Cmd>lua require"ky.config.gitsigns".undo_stage_hank()<CR>',
